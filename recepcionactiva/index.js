...
const CONCESIONARIOS = [
  {
    name: 'MOTORSUR - AREQUIPA AVIACIÓN',
    address: 'Av. Aviación Km. 7 Cerro Colorado<br>Arequipa<br>Teléfono: 054383101',
    icons: ['car', 'hammer-and-wrench', 'radiator'],
    position: { lat: -16.3726929, lng: -71.5777419 },
  },
  {
    name: 'LIMAUTOS - SURQUILLO',
    address: 'Av. República de Panamá<br>4679 – Surquillo, Lima<br>Teléfono: 016129292',
    icons: ['car', 'damage', 'electric-car'],
    position: { lat: -12.1063172, lng: -77.0227971 },
  },
  {
    name: 'INTERAMERICANA TRUJILLO - PIÉROLA',
    address: 'Av. Nicolás de Piérola 750 Urb. Primavera<br>Trujillo, La libertad<br>Teléfono: 044607777',
    icons: ['car', 'car-painting', 'car-wash'],
    position: { lat: -8.1026308, lng: -79.0373394 },
  },  
  {
    name: 'AUTOLAND - ATE',
    address: 'Av. Nicolas Ayllón 2466 Urb. Sta. Angélica<br>Ate Vitarte, Lima<br>Teléfono: 015005444',
    icons: ['car', 'flat-tire', 'car-wash'],
    position: { lat: -12.0613375, lng: -76.9811489 },
  },
];
...
class UI {
  ...
  dodajMarker(map, opcjeMarkera) {
    ...
    google.maps.event.addListener(marker, 'mousedown', function (event) {
      // const conce = event.vb.srcElement.attributes.title.value; // desktop version
      //   console.log('marker', marker);
      // alert('conce ' + conce);
      if (marker.title) {
        selConcesionario(marker.title);
      }
    });
  }
  ...
  fillMapConcesionarios() {
    ...
    const map = new google.maps.Map(document.getElementById('map'), { zoom: 6, center: derco });
